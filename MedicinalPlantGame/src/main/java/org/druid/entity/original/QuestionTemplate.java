...
public class QuestionTemplate {
    ...
    private String questionSubject; // The information in the question that will vary based on plant, either the plant name, a picture of the plant, or the ailment treated will be in the question
